...
/**
 * Represents a builder for an integer slash command option.
 */
export class IntegerOptionBuilder {
     ...
     * @returns {this} The IntegerOptionBuilder instance.
     */
     ...
     * @param {number} value The integer value of the choice.
     * @returns {this} The IntegerOptionBuilder instance.
     */
    ...
    public toJSON(): ApplicationCommandOption {
        if (typeof this._name === 'undefined' || typeof this._description === 'undefined') {
            throw new Error('Integer option name and description must be set before converting to JSON.');
        }
