...
/**
 * Represents a builder for a mentionable slash command option.
 */
export class MentionableOptionBuilder {
     ...
     * @returns {this} The MentionableOptionBuilder instance.
     */
    ...
    public toJSON(): ApplicationCommandOption {
        if (typeof this._name === 'undefined' || typeof this._description === 'undefined') {
            throw new Error('Mentionable option name and description must be set before converting to JSON.');
        }
