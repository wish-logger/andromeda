...
/**
 * Represents a builder for a boolean slash command option.
 */
export class BooleanOptionBuilder {
     ...
     * @returns {this} The BooleanOptionBuilder instance.
     */
    ...
    public toJSON(): ApplicationCommandOption {
        if (typeof this._name === 'undefined' || typeof this._description === 'undefined') {
            throw new Error('Boolean option name and description must be set before converting to JSON.');
        }
